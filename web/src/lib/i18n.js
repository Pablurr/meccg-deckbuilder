...
export const translations = {
  fr: {
    ...
    'rules.DECKSIZE-PLAY': 'Le talon a {count} cartes ; un deck {side} en requiert {min}–{max}. Ajoute ou retire des cartes pour respecter la plage.',
    ...
    'rules.POOL-MIND.total': "L'esprit total du pool de départ dépasse la limite ({total}/{max}). Échange des personnages à esprit plus faible jusqu'à revenir à {max} ou moins.",
    'rules.POOL-MIND.char': "{name} (esprit {mind}) dépasse la limite d'esprit par personnage du pool de départ, fixée à {limit}. Remplace-la par un personnage à esprit plus faible.",
    'rules.POOL-ITEMS': 'Le pool de départ a {count} objets mineurs ; {side} en autorise {max}. Sors-en {over}.',
  ...
  en: {
    ...
    'rules.DECKSIZE-PLAY': 'Play deck has {count} cards; a {side} deck requires {min}–{max}. Add or remove cards to fit the range.',
    ...
    'rules.POOL-MIND.total': 'Starting pool mind exceeds the limit ({total}/{max}). Swap in lower-mind characters until the pool total is at or below {max}.',
    'rules.POOL-MIND.char': "{name} (mind {mind}) exceeds the starting pool's per-character mind limit of {limit}. Swap it for a lower-mind character.",
    'rules.POOL-ITEMS': 'Starting pool has {count} minor items; {side} allows {max}. Move {over} out.',
  ...
  es: {
    ...
    'rules.DECKSIZE-PLAY': 'El mazo de juego tiene {count} cartas; un mazo {side} requiere {min}–{max}. Añade o quita cartas para ajustarte al rango.',
    ...
    'rules.POOL-MIND.total': 'La mente total de la reserva inicial supera el límite ({total}/{max}). Cambia por personajes de menor mente hasta llegar a {max} o menos.',
    'rules.POOL-MIND.char': '{name} (mente {mind}) supera el límite de mente por personaje de la reserva inicial, fijado en {limit}. Cámbiala por un personaje de menor mente.',
    'rules.POOL-ITEMS': 'La reserva inicial tiene {count} objetos menores; {side} permite {max}. Saca {over}.',
