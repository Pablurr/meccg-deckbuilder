...
export const translations = {
  fr: {
    ...
    'rules.DECKSIZE-PLAY': 'Le play deck a {count} cartes ; un deck {side} en requiert {min}–{max}. Ajoute ou retire des cartes pour respecter la plage.',
    'rules.DECKSIZE-LOCATION': 'Le location deck est vide — ajoute tes sites et régions.',
    'rules.SIDEBOARD-MAX': 'La réserve a {count} cartes ; la limite pour {length} est {max}. Sors-en {over}.',
    'rules.POOL-CHARS': 'Le pool de départ a {count} personnages ; {side} en autorise {max}. Sors-en {over} vers le play deck ou la réserve.',
    ...
    'rules.POOL-ELIGIBLE.type': "{name} ne peut pas être dans le pool de départ — seuls les personnages et les objets mineurs de départ y ont leur place. Déplace-la vers le play deck ou la réserve.",
    'rules.POOL-ELIGIBLE.race': '{name} ({race}) ne peut pas être dans le pool de départ — ce camp exclut cette race du pool. Déplace-la vers le play deck ou la réserve.',
