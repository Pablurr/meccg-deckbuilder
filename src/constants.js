...
export const CARD_W_BLEED = 816; // 2.72in @ 300 DPI
export const CARD_H_BLEED = 1110; // 3.70in @ 300 DPI

export const CARD_W_CUT = CARD_W_BLEED - 2 * BLEED_PX; // 744
export const CARD_H_CUT = CARD_H_BLEED - 2 * BLEED_PX; // 1038
